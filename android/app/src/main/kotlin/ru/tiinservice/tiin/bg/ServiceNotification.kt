...
import ru.tiinservice.tiin.Application
import ru.tiinservice.tiin.MainActivity
import ru.tiinservice.tiin.R
import ru.tiinservice.tiin.Settings
import ru.tiinservice.tiin.constant.Action
import ru.tiinservice.tiin.constant.Status
//import ru.tiinservice.tiin.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import ru.tiinservice.tiin.Application.Companion.notification
import ru.tiinservice.tiin.utils.GrpcClientProvider
...
//            CommandClient(GlobalScope, CommandClient.ConnectionType.Status, this)
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Settings.hideVPNNotification) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                Application.notification.createNotificationChannel(
                    NotificationChannel(
                        notificationChannel, "TIIN", NotificationManager.IMPORTANCE_MIN
                    ).apply {
                        setShowBadge(false)
                        enableLights(false)
