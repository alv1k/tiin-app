...
import ru.tiinservice.tiin.bg.ProxyService
import ru.tiinservice.tiin.bg.VPNService
import ru.tiinservice.tiin.constant.PerAppProxyMode
import ru.tiinservice.tiin.constant.ServiceMode
import ru.tiinservice.tiin.constant.SettingsKey
...
object Settings {
    ...
    var hideVPNNotification: Boolean
        get() = preferences.getBoolean("hide_vpn_notification", false)
        set(value) = preferences.edit().putBoolean("hide_vpn_notification", value).apply()
